...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { description: @business.description, email: @business.email, name: @business.name, owner: @business.owner }
    end
  ...
  test "should update business" do
    put :update, id: @business, business: { description: @business.description, email: @business.email, name: @business.name, owner: @business.owner }
    assert_redirected_to business_path(assigns(:business))
  end
